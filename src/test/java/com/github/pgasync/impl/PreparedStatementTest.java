...
public class PreparedStatementTest extends ConnectedTest {
    ...
    public void shouldBindLong() {
        ...
        assertEquals(Long.MIN_VALUE, query("SELECT LONG FROM PS_TEST WHERE LONG = $1", asList(Long.MIN_VALUE))
    ...
    public void shouldBindInt() {
        ...
        assertEquals(Integer.MAX_VALUE, query("SELECT INT FROM PS_TEST WHERE INT = $1", asList(Integer.MAX_VALUE))
    ...
    public void shouldBindShort() {
        ...
        assertEquals(Short.MIN_VALUE, query("SELECT SHORT FROM PS_TEST WHERE SHORT = $1", asList(Short.MIN_VALUE))
    ...
    public void shouldBindByte() {
        ...
        assertEquals(0x41, query("SELECT BYTE FROM PS_TEST WHERE BYTE = $1", asList(0x41)).get(0).getByte(0)
                .byteValue());
    }
    ...
    public void shouldBindChar() {
        ...
        assertEquals('€', query("SELECT CHAR FROM PS_TEST WHERE CHAR = $1", asList('€')).get(0).getChar(0)
                .charValue());
    }
    ...
    public void shouldBindClob() {
        ...
        assertEquals(text, query("SELECT CLOB FROM PS_TEST WHERE CLOB = $1", asList(text)).get(0).getString(0));
    }
