...
public class PreparedStatementTest {
    ...
    public void shouldBindByte() {
        ...
        assertEquals(0x41, dbr.query("SELECT BYTE FROM PS_TEST WHERE BYTE = $1", asList(0x41)).at(0).getByte(0)
                .byteValue());
    }
    ...
    public void shouldBindChar() {
        ...
        assertEquals('€', dbr.query("SELECT CHAR FROM PS_TEST WHERE CHAR = $1", asList('€')).at(0).getChar(0)
                .charValue());
    }
    ...
    public void shouldBindString() {
        ...
        assertEquals("val",
                dbr.query("SELECT STRING FROM PS_TEST WHERE STRING = $1", asList("val")).at(0).getString(0));
    }
    ...
    public void shouldBindClob() {
        ...
        assertEquals(text, dbr.query("SELECT CLOB FROM PS_TEST WHERE CLOB = $1", asList(text)).at(0).getString(0));
    }
    ...
    public void shouldBindTime() throws Exception {
        ...
        assertEquals(time, dbr.query("SELECT TIME FROM PS_TEST WHERE TIME = $1", asList(time)).at(0).getTime(0));
    }
    ...
    public void shouldBindTimestamp() throws Exception {
        ...
        assertEquals(ts, dbr.query("SELECT TS FROM PS_TEST WHERE TS = $1", asList(ts)).at(0).getTimestamp(0));
    }
    ...
    public void shouldBindDate() throws Exception {
        ...
        assertEquals(date, dbr.query("SELECT DATE FROM PS_TEST WHERE DATE = $1", asList(date)).at(0).getDate(0));
    }
    ...
    public void shouldBindBytes() throws Exception {
        ...
        assertArrayEquals(b, dbr.query("SELECT BYTEA FROM PS_TEST WHERE BYTEA = $1", asList(b)).at(0).getBytes(0));
    }
    ...
    public void shouldBindBoolean() throws Exception {
        ...
        assertTrue((Boolean) ((PgRow) dbr.query("SELECT BOOLEAN FROM PS_TEST WHERE BOOLEAN = $1",
                singletonList(true)).at(0)).get("BOOLEAN"));
